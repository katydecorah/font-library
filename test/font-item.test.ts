...
describe("FontItem", () => {
  ...
  test("renders correctly", () => {
    document.body.innerHTML = `<li is="font-item" font='{"family":"Alef","variants":["regular","700"],"subsets":["hebrew","latin"],"category":"sans-serif","tags":["geometric"],"lineNumber":23}'></li>`;
  ...
  test("no latin subset", () => {
    document.body.innerHTML = `<li is="font-item" font='{"family":"GFS Neohellenic","variants":["regular","italic","700","700italic"],"subsets":["greek"],"category":"sans-serif","tags":["round","monolinear","1930s"],"lineNumber":439}'></li>`;
    const fontItem = document.querySelector("li[is='font-item']");
    expect(fontItem).toMatchSnapshot();
    expect(
      document
  ...
  test("rtl subset", () => {
    document.body.innerHTML = `<li is="font-item" font='{"family":"Almarai","variants":["300","regular","700","800"],"subsets":["arabic"],"category":"sans-serif","tags":["arabic"],"lineNumber":41}'></li>`;
    const fontItem = document.querySelector("li[is='font-item']");
    expect(fontItem).toMatchSnapshot();
    expect(
  ...
  test("selected variant, 900", () => {
    document.body.innerHTML = `<li is="font-item" selected-variant="900"  font='{"family":"Anybody","variants":["100","200","300","regular","500","600","700","800","900","100italic","200italic","300italic","italic","500italic","600italic","700italic","800italic","900italic"],"subsets":["latin","latin-ext","vietnamese"],"category":"display","tags":["eurostile"],"lineNumber":78}'></li>`;
    const fontItem = document.querySelector("li[is='font-item']");
    expect(fontItem).toMatchSnapshot();
    expect(
      document.querySelector("[data-family='Anybody']").getAttribute("href"),
  ...
  test("selected subset", () => {
    document.body.innerHTML = `<li is="font-item" selected-subset="hebrew" font='{"family":"Alef","variants":["regular","700"],"subsets":["hebrew","latin"],"category":"sans-serif","tags":["geometric"],"lineNumber":23}'></li>`;
    const fontItem = document.querySelector("li[is='font-item']");
    expect(fontItem).toMatchSnapshot();
    expect(
      document.querySelector("[data-family='Alef']").getAttribute("href"),
  ...
  test("has family name that exists in swaps.json", () => {
    document.body.innerHTML = `<li is="font-item" font='{"family":"Material Symbols Sharp","variants":["100","200","300","regular","500","600","700"],"subsets":["latin"],"category":"monospace","tags":[],"lineNumber":752}'></li>`;
    const fontItem = document.querySelector("li[is='font-item']");
    expect(fontItem).toMatchSnapshot();
    expect(
      document
  ...
  test("is variable font", () => {
    document.body.innerHTML = `<li is="font-item" font='{"family":"Akshar","variants":["300","regular","500","600","700"],"subsets":["devanagari","latin","latin-ext"],"category":"sans-serif","tags":["condensed","narrow"],"lineNumber":17,"variable":true}'></li>`;
    const fontItem = document.querySelector("li[is='font-item']");
    expect(fontItem).toMatchSnapshot();
    expect(
  ...
  test("unifrakturcook, one non-regular variant", () => {
    document.body.innerHTML = `<li is="font-item" font='{"family":"UnifrakturCook","variants":["700"],"subsets":["latin"],"category":"display","tags":[],"lineNumber":1020}'></li>`;
    expect(
      document
