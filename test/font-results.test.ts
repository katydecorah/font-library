...
describe("FontResults", () => {
  ...
  test("renders correctly", () => {
    document.body.innerHTML = `<div id="content"><font-results selected-category="" selected-subset="" selected-variant="" selected-tag="" search="" selected-variable=""></font-results></div>`;
